...
namespace Infrastrucutre.Migrations
{
    ...
    [Migration("20231206082121_AddedCouponsTableAndItsRelationWithPatientEntity")]
    partial class AddedCouponsTableAndItsRelationWithPatientEntity
    {
            ...
            modelBuilder.Entity("Domain.Entities.Coupon", b =>
                {
                    b.HasOne("Domain.Entities.CustomUser", "Patient")
                        .WithOne("Coupon")
                        .HasForeignKey("Domain.Entities.Coupon", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
