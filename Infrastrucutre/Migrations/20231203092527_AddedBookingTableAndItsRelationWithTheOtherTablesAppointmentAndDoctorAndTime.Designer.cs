...
namespace Infrastrucutre.Migrations
{
    ...
    [Migration("20231203092527_AddedBookingTableAndItsRelationWithTheOtherTablesAppointmentAndDoctorAndTime")]
    partial class AddedBookingTableAndItsRelationWithTheOtherTablesAppointmentAndDoctorAndTime
    {
            ...
            modelBuilder.Entity("Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Doctor", "Dcotor")
                        .WithMany("Bookings")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
